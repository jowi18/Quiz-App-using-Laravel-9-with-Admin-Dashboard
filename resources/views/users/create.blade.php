                        ...
                        <div class="module">
                            ...
                            <div class="module-body">
                            	<form action="/user/create" method="POST">
                                    ...
                                    <div class="control-group">
                                        <label class="control-lable" for="password">Re-type Password</label>
                                        <div class="controls"> 
                                            <input type="password" name="password_confirmation" class="span8 @error('password') border-red @enderror" placeholder="password" value="{{old('password')}}" >
                                        </div>
